...
// My Array
float myReadings[] = { readings_ADT7410.getTempC(), readings_MCP9808.getTempC() };
...
void setup() {
  ...
  float myReadings[] = { readings_Si7021.getTempC(), readings_MCP9808.getTempC(), readings_Si7021.getHumidity() 
  
  };

  //myReadings[0] = readings_Si7021.getTempC();
  //myReadings[1] = readings_MCP9808.getTempC();
  //myReadings[2] = readings_Si7021.getHumidity();
  Serial.println("Printing Array:");
  for (byte i=0; i < myReadings.length(); i=i+1){
    Serial.print(i);
    Serial.print(": ");
